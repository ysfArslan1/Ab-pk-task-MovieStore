...
{
    public class GetMovieActorDetailQueryValidatorTests: IClassFixture<CommonTextFicture>
    {
        private readonly PatikaDbContext _dbcontext;
        private readonly IMapper _mapper;
        public GetMovieActorDetailQueryValidatorTests(CommonTextFicture textFicture)
        {
        ...
        {
            // Arrange
            var validator = new GetMovieActorDetailQueryValidator();
            var item = new GetMovieActorDetailQuery(_dbcontext,_mapper);
        ...
        public void WhenIdIsProvided_ShouldNotHaveValidationError()
        {
            ...
            var validator = new GetMovieActorDetailQueryValidator();
            var item = new GetMovieActorDetailQuery(_dbcontext, _mapper);
            item.Id = _dbcontext.MovieActors.First().Id;
